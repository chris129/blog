...
SECRET_KEY = 'jimbgd&ak3bep!-%60j9ob)f6-@&+t848ucxa+ikwudduejxs8'
...
# 虽然目前这个引擎还不存在，但我们接下来会创建它。PATH 指定了索引文件需要存放的位置，我们设置为项目根目录
# BASE_DIR 下的 whoosh_index 文件夹（在建立索引是会自动创建）。
